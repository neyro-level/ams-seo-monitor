...
Группа `14 дней / Месяц / Квартал / Полгода`: muted-контейнер, border, радиус 12px, padding 6px. Пункт минимум 40px, горизонтальный padding 16px. Active — navy/white, inactive — white/slate. Группа переносится, но не ужимает текст. Sticky не является стандартом.
