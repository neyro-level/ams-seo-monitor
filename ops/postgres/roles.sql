...
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA tools, research TO ams_web, ams_worker;
...
ALTER DEFAULT PRIVILEGES FOR ROLE ams_migrator IN SCHEMA tools
  GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO ams_web, ams_worker;
ALTER DEFAULT PRIVILEGES FOR ROLE ams_migrator IN SCHEMA research
  GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO ams_web, ams_worker;
GRANT SELECT ON ALL TABLES IN SCHEMA public TO ams_backup;
GRANT SELECT ON ALL TABLES IN SCHEMA tools, research TO ams_backup;
ALTER DEFAULT PRIVILEGES FOR ROLE ams_migrator IN SCHEMA public
