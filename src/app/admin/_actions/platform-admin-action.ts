...
function mapError(error: unknown) {
  ...
  const messages: Record<string, string> = {
    ...
    PROJECT_ACCESS_NOT_FOUND_OR_FORBIDDEN: "Назначение проекта не найдено.",
    PROJECT_ACCESS_STALE: "Назначение уже изменилось. Обновите страницу.",
    PROJECT_ACCESS_ALREADY_EXISTS: "У пользователя уже есть доступ к этому проекту.",
    PROJECT_ACCESS_REFERENCE_INVALID: "Пользователь и проект должны относиться к одной организации.",
