...
function mapError(error: unknown) {
  ...
  const messages: Record<string, string> = {
    IDENTITY_ADMIN_ACCESS_DENIED: "Недостаточно прав для администрирования.",
    ...
    ORGANIZATION_SLUG_CONFLICT: "Организация с таким кодом уже существует.",
    ...
    SITE_SLUG_CONFLICT: "В проекте уже есть сайт с таким кодом.",
    PROJECT_REGISTRY_ADMIN_ACCESS_DENIED: "Недостаточно прав для изменения реестра.",
    SITE_CONFLICT: "Сайт с таким кодом уже существует в проекте.",
    ...
    GOAL_DEFINITION_CONFLICT: "Цель с таким идентификатором уже существует в проекте.",
    ...
    THRESHOLD_PROFILE_NOT_FOUND_OR_FORBIDDEN: "Правила оценки недоступны.",
    THRESHOLD_PROFILE_REFERENCE_INVALID: "Правила оценки недоступны.",
    THRESHOLD_PROFILE_SLUG_CONFLICT: "Правила оценки с таким кодом уже существуют.",
    THRESHOLD_PROFILE_STALE: "Правила оценки уже изменены. Обновите страницу.",
    QUERY_CLUSTER_PROFILE_NOT_FOUND_OR_FORBIDDEN: "Группы запросов недоступны.",
    QUERY_CLUSTER_PROFILE_REFERENCE_INVALID: "Группы запросов недоступны.",
    QUERY_CLUSTER_PROFILE_SLUG_CONFLICT: "Группы запросов с таким кодом уже существуют.",
    QUERY_CLUSTER_PROFILE_STALE: "Группы запросов уже изменены. Обновите страницу.",
    PLATFORM_OPERATIONS_ADMIN_ACCESS_DENIED: "Недостаточно прав для запуска обновления данных.",
