...
const syntheticSnapshot = siteReportSnapshotSchema.parse({
  ...
  sources: {
    webmaster: {
      status: "success",
      fetchedAt: "2026-08-27T09:10:00+03:00",
    ...
    metrica: {
      status: "success",
      fetchedAt: "2026-08-27T09:15:00+03:00",
      periodStart: "2026-07-30",
      periodEnd: "2026-08-26",
      timezone: "+03:00",
  ...
  webmaster: {
    ...
    visibilityTrend: [
      { label: "30 июл", date: "2026-07-30", value: 1320, secondaryValue: 174, tertiaryValue: 8.2 },
      { label: "06 авг", date: "2026-08-06", value: 1410, secondaryValue: 182, tertiaryValue: 8.0 },
      { label: "13 авг", date: "2026-08-13", value: 1495, secondaryValue: 205, tertiaryValue: 7.8 },
      { label: "20 авг", date: "2026-08-20", value: 1575, secondaryValue: 218, tertiaryValue: 7.6 },
      { label: "27 авг", date: "2026-08-27", value: 1660, secondaryValue: 244, tertiaryValue: 7.4 },
    ],
    queries: [
      {
        queryId: "q-1",
        ...
        ctr: 10.95,
        avgShowPosition: 5.7,
        avgClickPosition: 5.1,
        previousShows: 381,
        previousClicks: 38,
        deltaClicksPercent: 21.1,
        deltaCtrPoints: 0.97,
        opportunityType: "позиции 4–10",
      },
      {
        queryId: "q-2",
        ...
        ctr: 45.77,
        avgShowPosition: 1.8,
        avgClickPosition: 1.4,
        previousShows: 244,
        previousClicks: 110,
        deltaClicksPercent: 8.2,
        deltaCtrPoints: 0.69,
        opportunityType: "бренд",
      },
      {
        queryId: "q-3",
        ...
        ctr: 3.39,
        avgShowPosition: 6.6,
        avgClickPosition: 5.7,
        previousShows: 106,
        previousClicks: 7,
        deltaClicksPercent: -42.9,
        deltaCtrPoints: -3.21,
  ...
  metrica: {
    summary: {
      ...
      bounceRate: 18.4,
      depth: 3.1,
      averageVisitDurationSeconds: 196,
      goalReaches: 74,
      conversionRate: 5.8,
    },
    organicTrend: [
      { label: "30 июл", date: "2026-07-30", value: 142, secondaryValue: 10, tertiaryValue: 5.1 },
      { label: "06 авг", date: "2026-08-06", value: 155, secondaryValue: 12, tertiaryValue: 5.4 },
      { label: "13 авг", date: "2026-08-13", value: 169, secondaryValue: 14, tertiaryValue: 5.6 },
      { label: "20 авг", date: "2026-08-20", value: 176, secondaryValue: 16, tertiaryValue: 5.7 },
      { label: "27 авг", date: "2026-08-27", value: 188, secondaryValue: 22, tertiaryValue: 5.8 },
    ],
    landingPages: [
      {
        path: "/novostroyki/",
        ...
        goals: 18,
        conversionRate: 4.6,
        trendLabel: "+11% к прошлому периоду",
      },
      {
        path: "/ipoteka/",
        visits: 244,
      ...
      },
      {
        ...
        goals: 4,
        conversionRate: 2.6,
        trendLabel: "ниже среднего",
      },
    ],
    devices: [
      { device: "Desktop", visits: 514, conversionRate: 6.4 },
      { device: "Mobile", visits: 656, conversionRate: 5.1 },
      { device: "Tablet", visits: 82, conversionRate: 4.9 },
      { device: "Other", visits: 32, conversionRate: null },
    ],
    goals: [
      { label: "Отправка заявки", category: "lead_submit", reaches: 41, conversionRate: 3.2 },
      { label: "Клик по телефону", category: "phone_click", reaches: 23, conversionRate: 1.8 },
      { label: "Старт формы", category: "form_start", reaches: 10, conversionRate: 0.8 },
    ],
  },
  combined: {
    funnel: {
    ...
    opportunities: [
      ...
      {
        id: "opp-3",
        title: "Снять трение на /vtorichka/",
        summary: "Landing page даёт трафик, но по глубине и отказам слабее соседних направлений.",
        source: "metrica",
        tone: "warning",
      },
    ],
...
function cloneSnapshot(snapshot: SiteReportSnapshot): SiteReportSnapshot {
  return JSON.parse(JSON.stringify(snapshot)) as SiteReportSnapshot;
}

const demoSnapshot = siteReportSnapshotSchema.parse({
  ...cloneSnapshot(syntheticSnapshot),
  clientSlug: "demo",
  siteSlug: "overview",
